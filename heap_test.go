...
func TestHeapImplementations(t *testing.T) {
    ...
    t.Run("int_min_heap", func(t *testing.T) {
        ...
        makeHeap := func() Heap[int] { return NewRWMutexHeap[int](less) }
    ...
    t.Run("string_min_heap", func(t *testing.T) {
        ...
        makeHeap := func() Heap[string] { return NewRWMutexHeap[string](less) }
    ...
    t.Run("struct_custom_less", func(t *testing.T) {
        ...
        makeHeap := func() Heap[task] { return NewRWMutexHeap[task](less) }
